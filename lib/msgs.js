...
export const obterMensagensTexto = async () => {
    ...
    return {
        ...
        grupo: {
            ...
            antilinkGrupo: {
                motivo: "Banido pelo ANTI-LINK",
                detectou: "🤖 Ei @{p1}, o ANTI-LINK DE GRUPOS está ativado e um possível link foi detectado na sua mensagem, ela foi apagada por segurança.",
                ligado: "✅ O recurso de ANTI-LINK DE GRUPOS foi ativado com sucesso",
                desligado: "✅ O recurso de ANTI-LINK DE GRUPOS foi desativado com sucesso"
            },
            autosticker: {
            ...
            mt: {
                resposta: "Marcação do(a) ADM: *{p1}*\n",
                resposta_motivo: "Marcação do(a) ADM: *{p1}*\n\n" +
                    "Mensagem: *{p2}*\n"
            },
            mm: {
                resposta: "Marcação do(a) ADM: *{p1}*\n",
        ...
        diversao: {
            ...
            viadometro: {
                respostas: [' 0%\n\n - ESSE É ORGANIZADO ',
                    ...
                    '████             40%\n\n - DESORGANIZADO',
                    '██████         60%\n\n - MUITO DESORGANIZADO',
                    '████████     80%\n\n - NÍVEL ALTO DE DESORGANIZAÇÂO',
                    '██████████ 100%\n\n - ALERTA VERMELHO, NÍVEL MÁXIMO DE DESORGANIZAÇÂO'],
                apenas_um: "[❗] Erro: Apenas um membro por vez deve ser mencionado.",
                resposta: "🧩 *NÍVEL DE DESORGANIZAÇÂO* - {p1}"
            },
            gadometro: {
                respostas: [' 0%\n\n - ESSE NÃO É GADO ',
